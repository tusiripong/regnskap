...
<head>
    ...
    ?>
	<link rel='stylesheet' type='text/css' href='<?php echo Template::theme_url('css/bootstrap-multiselect.css'); ?>' media='screen' />
	<link rel='stylesheet' type='text/css' href='<?php echo Template::theme_url('css/bootstrap_old.css?v=1'); ?>' media='screen' />
	
        <script src="<?php //echo Template::theme_url('js/jquery.js'); ?>"></script>
        <script src="<?php echo Template::theme_url('js/jquery.min.js'); ?>"></script>
        <script src="<?php echo Template::theme_url('js/jquery.tablesorter.combined.js'); ?>"></script>  
        <script src="<?php echo Template::theme_url('js/jquery.tablesorter.js'); ?>"></script>     
        <script src="<?php echo Template::theme_url('js/jquery.tablesorter.widgets.js'); ?>"></script>  
	<script src="<?php echo Template::theme_url('js/modernizr-2.5.3.js'); ?>"></script>
	<script src="<?php echo Template::theme_url('js/jquery.number.js'); ?>"></script>
	<script src="<?php echo Template::theme_url('js/bootstrap-multiselect.js'); ?>"></script>
	<script src="<?php echo Template::theme_url('js/modal.js'); ?>"></script>
        <script src="<?php echo Template::theme_url('js/jquery.uploadfile.js'); ?>"></script>
        <script src="<?php echo Template::theme_url('js/bootstrap-datepicker.js'); ?>"></script>   
        <script src="<?php echo Template::theme_url('js/dhtmlxcalendar.js'); ?>"></script>     
    ...
    <div class="navbar navbar-static-top navbar-inverse" id="topbar" >
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <?php endif;?>
                <div class="nav-collapse in_backup collapse">
                    <!-- User Menu -->
