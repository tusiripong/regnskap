...
if (defined('CI_VERSION') && substr(CI_VERSION, 0, 1) != '2') {
    ...
    $db['default'] = array(
        'dsn'          => '',
        'hostname'     => 'k12stage.crjtmfni5tq5.eu-north-1.rds.amazonaws.com',
        'username'     => 'root',
        'password'     => 'Th3futur3',
        'database'     => 'regnskap_live',
        'dbdriver'     => 'mysqli',
        'dbprefix'     => 'bf_',
    ...
    $db['default']['hostname'] = 'k12stage.crjtmfni5tq5.eu-north-1.rds.amazonaws.com';
    $db['default']['username'] = 'root';
    $db['default']['password'] = 'Th3futur3';
    $db['default']['database'] = 'regnskap_live';
    $db['default']['port']     = '';
